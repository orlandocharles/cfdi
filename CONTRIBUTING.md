...
Contributions are welcome. We accept pull requests on [GitHub](https://github.com/eclipxe13/cfdi).

This project adheres to a
[Contributor Code of Conduct](https://github.com/eclipxe13/cfdi/blob/master/CODE_OF_CONDUCT.md).
By participating in this project and its community, you are expected to uphold this code.

## Team members

* [Carlos C Soto](https://github.com/eclipxe13) - original author and maintainer
* [GitHub constributors](https://github.com/eclipxe13/cfdi/graphs/contributors)

## Communication Channels

You can find help and discussion in the following places:

* GitHub Issues: <https://github.com/eclipxe13/cfdi/issues>

## Reporting Bugs

Bugs are tracked in our project's [issue tracker](https://github.com/eclipxe13/cfdi/issues).
...
[issues](https://github.com/eclipxe13/cfdi/issues) or active
[pull requests](https://github.com/eclipxe13/cfdi/pulls)
...
vendor/bin/phpstan.phar analyze -l max src/ tests/
```
